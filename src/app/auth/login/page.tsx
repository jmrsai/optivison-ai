...
export default function LoginPage() {
  ...
  const handleSocialLogin = async (provider: 'google' | 'github') => {
    ...
    try {
      ...
      toast({
        title: 'Login Successful',
        description: `Welcome! You've successfully signed in with ${provider === 'google' ? 'Google' : 'GitHub'}.`,
      });
      router.push('/');
    } catch (error: any) {
      ...
      toast({
        variant: 'destructive',
        title: 'Login Failed',
        description: `Could not sign in with ${provider === 'google' ? 'Google' : 'GitHub'}. Please try again.`,
      });
    }
  };
